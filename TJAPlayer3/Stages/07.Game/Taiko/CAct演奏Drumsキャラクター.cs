            ...
            for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
            {
                ...
                if (bマイどんアクション中[i])
                {
                    ...
                    if (CharaAction_Balloon_Broke[i]?.b進行中 == true && TJAPlayer3.Skin.Game_Chara_Ptn_Balloon_Broke != 0)
                    {
                        ...
                        TJAPlayer3.stage演奏ドラム画面.PuchiChara.On進行描画((TJAPlayer3.Skin.nScrollFieldX[i] - TJAPlayer3.stage演奏ドラム画面.actLaneTaiko.nDefaultJudgePos[i, 0]) + TJAPlayer3.Skin.Game_PuchiChara_BalloonX[i], TJAPlayer3.Skin.Game_PuchiChara_BalloonY[i], false, i, nowOpacity, true);
                    ...
                    else if (CharaAction_Balloon_Miss[i]?.b進行中 == true && TJAPlayer3.Skin.Game_Chara_Ptn_Balloon_Miss != 0)
                    {
                        ...
                        TJAPlayer3.stage演奏ドラム画面.PuchiChara.On進行描画((TJAPlayer3.Skin.nScrollFieldX[i] - TJAPlayer3.stage演奏ドラム画面.actLaneTaiko.nDefaultJudgePos[i, 0]) + TJAPlayer3.Skin.Game_PuchiChara_BalloonX[i], TJAPlayer3.Skin.Game_PuchiChara_BalloonY[i], false, i, nowOpacity, true); if (CharaAction_Balloon_Miss[i].b終了値に達した)
                        {
                    ...
                    else if (CharaAction_Balloon_Breaking[i]?.b進行中 == true && TJAPlayer3.Skin.Game_Chara_Ptn_Balloon_Breaking != 0)
                    {
                        ...
                        TJAPlayer3.stage演奏ドラム画面.PuchiChara.On進行描画((TJAPlayer3.Skin.nScrollFieldX[i] - TJAPlayer3.stage演奏ドラム画面.actLaneTaiko.nDefaultJudgePos[i, 0]) + TJAPlayer3.Skin.Game_PuchiChara_BalloonX[i], TJAPlayer3.Skin.Game_PuchiChara_BalloonY[i], false, i, 255, true);
                    }
                }
            }
        }
