...
namespace TJAPlayer3
{
    ...
    internal class CSkin : IDisposable
    {
        ...
        public Cシステムサウンド soundTaikoS = null;
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.soundTaikoS = new Cシステムサウンド(@"Sounds\TaikoS.ogg", false, false, false, ESoundGroup.Voice);
            this.soundsanka = new Cシステムサウンド(@"Sounds\sanka.ogg", false, false, false, ESoundGroup.Voice);
            this.soundModeS = new Cシステムサウンド(@"Sounds\ModeS.ogg", false, false, false, ESoundGroup.Voice);
        ...
        public int SongLoading_Title_Y = 275;
        public int SongLoading_SubTitle_X = 640;
        public int SongLoading_SubTitle_Y = 320;
        ...
        public int[] Game_Score_Add_X = new int[] { 35, 35, 0, 0 };
        ...
        public int[] Game_Taiko_Y = new int[] { 206, 383 };
        public int[] Game_Taiko_Combo_X = new int[] { 267, 267 };
        public int[] Game_Taiko_Combo_Y = new int[] { 272, 450 };
        ...
        public int[] Game_Taiko_Combo_Ex4_Y = new int[] { 273, 450 };
        ...
        public int[] Game_Balloon_Roll_Number_Y = new int[] { 112, 639 };
        ...
        #endregion
        #region PuchiChara
        public int[] Game_PuchiChara_X = new int[] { 135, 135 };
        public int[] Game_PuchiChara_Y = new int[] { 140, 680 };
        ...
        public int[] Game_DanC_Offset = new int[] { 259, 27 };//ゲージの中の座標
        ...
        public int Result_MusicName_Y = 35;
        public int Result_MusicName_FontSize = 28;
